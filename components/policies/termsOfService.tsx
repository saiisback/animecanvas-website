...
function TermsOfService() {
  return (
    <div className="max-w-full mx-auto p-6 mt-6 bg-white shadow-lg rounded-lg border border-gray">
      <h2 className="text-7xl font-bold text-gray-800 mb-4">Terms of Service</h2>
      <p className="text-gray-700 mb-4">
        Last updated on <strong>16-02-2024 18:25:04</strong>
      </p>
      <ol className="list-decimal list-inside text-gray-700 mb-4 space-y-2">
        <li>
          These Terms and Conditions, along with privacy policy or other terms (“Terms”) constitute a binding
          agreement by and between ANIME CANVAS, ( “Website Owner” or “we” or “us” or “our”) and you (“you” or
        ...
        <li>
          ...
          Service you have availed or within the time period provided you do a refund claim within the
          stipulated time of within 7 days of delivery of the product, then this would make you eligible for
          a refund.
        </li>
        <li>
          In case you do not raise a refund claim within the stipulated time of within 7 days of delivery of
          the product, then this would make you eligible for a refund.
        </li>
        <li>
          Notwithstanding anything contained in these Terms, the parties shall not be liable for any failure
          to perform an obligation under these Terms if performance is prevented or delayed by a force
          majeure event.
        </li>
        <li>
